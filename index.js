...
let totalChange = 0;
let greatestIncrease_date = "";
let greatestIncrease_amount = 0;
let greatestDecrease_date = "";
let greatestDecrease_amount = 0;
...
for (let i = 0; i < finances.length; i++) {
  ...
  if (i > 0) {
    ...
    totalChange += change;
    if (change > greatestIncrease_amount) {
      greatestIncrease_date = date;
      greatestIncrease_amount = change;
    } else if (change < greatestDecrease_amount) {
      greatestDecrease_date = date;
      greatestDecrease_amount = change;
    }
  }
}
